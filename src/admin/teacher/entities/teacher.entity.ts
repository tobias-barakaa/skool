...
export class Teacher {
  ...
  // --- CHANGE STARTS HERE ---
  // Removed the explicit `userId` column.
  // The `user_id` foreign key is now solely managed by this OneToOne relation.
  @OneToOne(() => User, { nullable: true })
  @JoinColumn({ name: 'user_id' }) // This column will store the user's ID
