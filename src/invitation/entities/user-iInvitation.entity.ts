...
import { CreateTeacherInvitationDto } from 'src/teacher/dtos/create-teacher-invitation.dto';
...
export class UserInvitation {
  ...
  @ManyToOne(() => User, user => user.sentInvitations, { nullable: true, onDelete: 'SET NULL' })
